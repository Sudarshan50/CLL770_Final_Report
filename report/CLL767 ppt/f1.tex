...
\begin{frame}[plain]
    ...
    \vspace{-0.5cm}
    \begin{center}
        \small Presented by: Yash Sakhare (2022CH71496), Sudarshan Oraon (2022CH71511)
    \end{center}
\end{frame}
...
\begin{frame}{What is Polyvinylidene Fluoride (PVDF)?}
    ...
    \begin{exampleblock}{Molecular Weight Engineering}
        \footnotesize Battery grades: $M_w$ $\sim$600,000 g/mol\textsuperscript{[2]}; Ultra-high grades: $>$1,000,000 g/mol\textsuperscript{[2]}
    \end{exampleblock}
\end{frame}
...
\begin{frame}{The Key to PVDF: Crystalline Polymorphism}
    ...
    \begin{exampleblock}{Performance Impact}
        $\beta$-dominant PVDF binder: \textbf{185 mAh/g capacity \& 98\% retention} vs. $\alpha$-phase: 71.6\% retention after 50 cycles\textsuperscript{[1]}
    \end{exampleblock}
\end{frame}
    ...
    \begin{columns}[T]
        \begin{column}{0.48\textwidth}
            \begin{block}{Glass Transition ($T_g$)}
                \begin{itemize}
                    \item \textbf{Value:} -35 to -40\si{\celsius}\textsuperscript{[1]}
        ...
        \begin{column}{0.48\textwidth}
            \begin{alertblock}{Melting Temperature ($T_m$)}
                \begin{itemize}
                    \item \textbf{Value:} 165-175\si{\celsius}\textsuperscript{[1,2]}
                    \item \textbf{Critical safety advantage!}
                    \item PE/PP separators melt at $\sim$130\si{\celsius}\textsuperscript{[2]}
...
\begin{frame}{The Master Property: Crystallinity}
    \begin{block}{Percent Crystallinity (\%)}
        \begin{itemize}
            \item Typical PVDF: 50-70\% crystalline\textsuperscript{[1]}
            \item Battery grades: engineered from 14\% to 32\%\textsuperscript{[11]}
    ...
    \begin{alertblock}{Decomposition Temperature}
        \begin{itemize}
            \item \textbf{Onset:} $>$400\si{\celsius} (TGA data)\textsuperscript{[1]}
            \item Electrodes dried at $\sim$130\si{\celsius} (NMP evaporation)\textsuperscript{[9]}
            \item \textbf{Wide processing window} ensures polymer integrity
        \end{itemize}
    \end{alertblock}
    
    \begin{exampleblock}{Crystallization Kinetics (Avrami Model)}
        \footnotesize $1 - V_c(t) = \exp(-kt^n)$ with $n = 1.5-2.4$\textsuperscript{[1]}; $T_m^0 = 182$\si{\celsius}\textsuperscript{[1]}
    \end{exampleblock}
\end{frame}

\begin{frame}{The Crystallinity Trade-Off: Data}
    \begin{table}
        \caption{Influence of PVDF Crystallinity on Electrode Performance\textsuperscript{[11]}}
        \centering\small
        \begin{tabular}{lccl}
            \toprule
    ...
    \begin{columns}[T]
        \begin{column}{0.48\textwidth}
            \begin{block}{Electrochemical Stability}
                \begin{itemize}\small
                    \item \textbf{The Gold Standard: 0-5 V}\textsuperscript{[2,10]}
            ...
            \begin{block}{Dielectric Constant}
                \begin{itemize}\small
                    \item \textbf{Value:} $\epsilon$ = 8.4 to 12\textsuperscript{[1]}
...
\begin{frame}{Green Solvent Alternatives: Computational Screening}
    ...
    \vspace{-0.2cm}
    \begin{table}
        \caption{RED Values for PVDF Solvents\textsuperscript{[5]}}
        ...
        \begin{column}{0.48\textwidth}
            \begin{block}{Mechanical Analysis}
                ...
                \begin{itemize}\small
                    ...
                    \item PVDF: 8.7-48 N/m\textsuperscript{[6,7,11]}
                \end{itemize}
...
\begin{frame}{Application II: High-Performance Separator}
    ...
    \begin{table}
        \caption{PVDF vs. Polyolefin Separators\textsuperscript{[2,10]}}
        \centering\footnotesize
        \begin{tabular}{llll}
            \toprule
    ...
    \begin{columns}[T]
        ...
        \begin{column}{0.48\textwidth}
            ...
            \begin{exampleblock}{Future Solution: SC-CO$_2$ Extraction}
                \footnotesize \textbf{Supercritical CO$_2$ + DMSO co-solvent:}\textsuperscript{[3]}
                \begin{itemize}\footnotesize
...
\begin{frame}{Alternative Binders: Challenging Assumptions}
    ...
    \begin{table}
        \caption{Quantitative Binder Comparison\textsuperscript{[5,6,11,12]}}
        \centering\footnotesize
        \begin{tabular}{lcccc}
            \toprule
...
\begin{frame}{The Silicon Anode Solution}
    ...
    \begin{exampleblock}{PAA: The Enabling Binder}
        \small \textbf{Polyacrylic Acid (PAA) is the binder of choice for Si-anodes:}\textsuperscript{[7,8]}
        \begin{itemize}\small
            \item Unique: \textbf{high stiffness} ($\sim$8000 MPa) + \textbf{elasticity}
            \item Can withstand \& accommodate extreme stresses
            \item Higher carboxylic acid groups $\rightarrow$ stronger Si bonds\textsuperscript{[7,8]}
            \item Lower swelling (7.49\%) vs. SBR (9.56\%)\textsuperscript{[12]}
        \end{itemize}
    \end{exampleblock}
...
\begin{frame}{The Solution: CMC as Superior Na-Ion Binder}
    \vspace{-0.3cm}
    \begin{block}{Why Carboxymethyl Cellulose (CMC)?}
        \footnotesize Water-soluble biopolymer with \textbf{-COOH \& -OH groups} $\rightarrow$ chemical bonding\textsuperscript{[5,12]}
    \end{block}
    
    \vspace{-0.25cm}
    \begin{table}
        \caption{PVDF vs. CMC for Na-Ion Batteries\textsuperscript{[5,12,13]}}
        \centering\tiny
        \begin{tabular}{lccc}
            \toprule
            \textbf{Property} & \textbf{PVDF} & \textbf{CMC} & \textbf{Advantage} \\
            \midrule
            Processing & NMP (Toxic) & \textcolor{HighlightGreen}{\textbf{Water}} & \textcolor{HighlightGreen}{Green} \\
            Adhesion (N/cm) & $\sim$1.0 & \textcolor{HighlightGreen}{\textbf{1.1-1.7}} & \textcolor{HighlightGreen}{H-bond} \\
            Ionic Cond. (S/cm) & $\sim$10$^{-5}$ & \textcolor{HighlightGreen}{\textbf{$\sim$10$^{-2}$}} & \textcolor{HighlightGreen}{1000$\times$} \\
            Swelling & 11-19\% & \textcolor{HighlightGreen}{\textbf{Lower}} & \textcolor{HighlightGreen}{Stable} \\
            $T_g$ & -35\si{\celsius} & \textcolor{HighlightGreen}{\textbf{186\si{\celsius}}} & \textcolor{HighlightGreen}{Rigid} \\
            Na System & \textcolor{AlertRed}{\textbf{Fails}} & \textcolor{HighlightGreen}{\textbf{Stable}} & \textcolor{HighlightGreen}{No NaF} \\
            \bottomrule
        \end{tabular}
    \end{table}
    
    \vspace{-0.2cm}
    \begin{exampleblock}{Key Advantages of CMC\textsuperscript{[5,12,13]}}
        \footnotesize
        \begin{itemize}\itemsep0pt
            \item \textbf{Ionic conductivity:} 1000$\times$ higher (10$^{-2}$ vs. 10$^{-5}$ S/cm)
            \item \textbf{Chemical adhesion:} -COOH groups form H-bonds (stronger than VdW)
            \item \textbf{Na compatibility:} No fluoride release; no NaF formation
        \end{itemize}
    \end{exampleblock}
\end{frame}
    ...
    \begin{columns}[T]
        \begin{column}{0.48\textwidth}
            \begin{block}{Market Size \& Growth}
                \small \textbf{Driven by EV \& grid storage:}\textsuperscript{[14]}
                \begin{itemize}\footnotesize
            ...
            \begin{block}{Key Manufacturers}
                \footnotesize \textbf{Global supply chain:}\textsuperscript{[14,15]}
                \begin{itemize}\footnotesize
...
\begin{frame}[allowframebreaks]{References}
    \footnotesize
    \begin{enumerate}
        \item Gregorio, R. Jr. \textit{Determination of the $\alpha$, $\beta$, and $\gamma$ crystalline phases of poly(vinylidene fluoride) films prepared at different conditions.} J. Appl. Polym. Sci. 2006, \textbf{100}, 3272–3279.
        
        \item Arora, P.; Zhang, Z. \textit{Battery Separators.} Chem. Rev. 2004, \textbf{104}(10), 4419–4462.
        
        \item Knez, Ž.; Markočič, E.; Leitgeb, M.; Primožič, M.; Knez Hrnčič, M.; Škerget, M. \textit{Industrial applications of supercritical fluids: A review.} Energy 2014, \textbf{77}, 235–243.
        
        \item Lee, J.-H.; Lee, S.; Paik, U.; Choi, Y.-M. \textit{Aqueous processing of natural graphite particulates for lithium-ion battery anodes and their electrochemical performance.} J. Power Sources 2005, \textbf{147}, 249–255.
        
        \item Bresser, D.; Buchholz, D.; Moretti, A.; Varzi, A.; Passerini, S. \textit{Alternative binders for sustainable electrochemical energy storage – the transition to aqueous electrode processing and bio-derived polymers.} Energy Environ. Sci. 2018, \textbf{11}, 3096–3127.
        
        \item Kovalenko, I.; Zdyrko, B.; Magasinski, A.; Hertzberg, B.; Milicev, Z.; Burtovyy, R.; Luzinov, I.; Yushin, G. \textit{A major constituent of brown algae for use in high-capacity Li-ion batteries.} Science 2011, \textbf{334}(6052), 75–79.
        
        \item Liu, W.-R.; Yang, M.-H.; Wu, H.-C.; Chiao, S. M.; Wu, N.-L. \textit{Enhanced cycle life of Si anode for Li-ion batteries by using modified elastomeric binder.} Electrochem. Solid-State Lett. 2005, \textbf{8}(2), A100–A103.
        
        \item Magasinski, A.; Dixon, P.; Hertzberg, B.; Kvit, A.; Ayala, J.; Yushin, G. \textit{High-performance lithium-ion anodes using a hierarchical bottom-up approach.} Nat. Mater. 2010, \textbf{9}, 353–358.
        
        \item Wood, D. L.; Li, J.; Daniel, C. \textit{Prospects for reducing the processing cost of lithium ion batteries.} J. Power Sources 2015, \textbf{275}, 234–242.
        
        \item Zhang, S. S. \textit{A review on the separators of liquid electrolyte Li-ion batteries.} J. Power Sources 2007, \textbf{164}(1), 351–364.
        
        \item Choi, N.-S.; Chen, Z.; Freunberger, S. A.; Ji, X.; Sun, Y.-K.; Amine, K.; Yushin, G.; Nazar, L. F.; Cho, J.; Bruce, P. G. \textit{Challenges facing lithium batteries and electrical double-layer capacitors.} Angew. Chem. Int. Ed. 2012, \textbf{51}, 9994–10024.
        
        \item Li, J.; Rulison, C.; Kiggans, J.; Daniel, C.; Wood, D. L. \textit{Superior performance of LiFePO$_4$ aqueous dispersions via corona treatment and surface energy optimization.} J. Electrochem. Soc. 2012, \textbf{159}(8), A1152–A1157.
        
        \item Komaba, S.; Ishikawa, T.; Yabuuchi, N.; Murata, W.; Ito, A.; Ohsawa, Y. \textit{Fluorinated ethylene carbonate as electrolyte additive for rechargeable Na batteries.} ACS Appl. Mater. Interfaces 2011, \textbf{3}(11), 4165–4168.
        
        \item Verified Market Research. \textit{Global Polyvinylidene Fluoride (PVDF) Market Size and Forecast 2024-2032.} https://www.verifiedmarketresearch.com (accessed Nov 2024).
        
        \item Kynar® PVDF Technical Information. \textit{Arkema High Performance Polymers.} https://www.arkema.com (accessed Nov 2024).
    \end{enumerate}
\end{frame}
