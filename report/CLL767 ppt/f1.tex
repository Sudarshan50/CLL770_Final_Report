    ...
    \begin{columns}[T]
        ...
        \begin{column}{0.48\textwidth}
            ...
            \begin{exampleblock}{Future Solution}
                \small \textbf{Green Solvent Recycling:} DMSO, DMI, or ethylene glycol to dissolve binder \& recover cathodes
            \end{exampleblock}
        \end{column}
    \end{columns}
\end{frame}
    ...
    \begin{columns}[T]
        \begin{column}{0.48\textwidth}
            \begin{block}{Market Size \& Growth}
                ...
                \begin{itemize}\footnotesize
                    \item Binder: \textbf{34.13\%} of revenue
                    \item Homopolymer: \textbf{68\%} share
                    \item APAC: \textbf{56.67\%} (China)
                \end{itemize}
        ...
        \begin{column}{0.48\textwidth}
            \begin{alertblock}{The Real Cost Problem}
                ...
                \begin{enumerate}\footnotesize
                    ...
                    \item CAPEX: Solvent recovery
                    \item OPEX: High-energy drying
                    \item Compliance: Environmental
                \end{enumerate}
            \end{alertblock}
            ...
            \begin{center}
                \begin{tikzpicture}[scale=0.55]
                    ...
                    \draw[fill=DarkNavy!70] (0,0) rectangle (0.8,2.3) node[midway, white, font=\tiny, rotate=90] {Solvent 25\%};
                    \draw[fill=AccentBlue!70] (1,0) rectangle (1.8,2.7) node[midway, white, font=\tiny, rotate=90] {CAPEX 30\%};
                    \draw[fill=AlertRed!70] (2,0) rectangle (2.8,2.3) node[midway, white, font=\tiny, rotate=90] {OPEX 25\%};
                    \draw[fill=HighlightGreen!70] (3,0) rectangle (3.8,1.8) node[midway, white, font=\tiny, rotate=90] {Compliance 20\%};
                    \node[font=\tiny] at (1.9,-0.5) {Cost Breakdown};
                \end{tikzpicture}
            \end{center}
        \end{column}
    \end{columns}
    ...
    \begin{columns}[T]
        \begin{column}{0.48\textwidth}
            \begin{block}{Path 1: "Greening" PVDF}
                ...
                \begin{itemize}\footnotesize
                    \item Validate \& scale green solvents
                    \item Direct recycling processes
            ...
            \begin{block}{Path 2: "Replacing" PVDF}
                ...
                \begin{itemize}\footnotesize
                    \item Aqueous binders (PAA, Alginate)
                    \item H-bonding for adhesion
                    \item Enable Si anode flexibility
                \end{itemize}
            \end{block}
        \end{column}
        ...
        \begin{column}{0.48\textwidth}
            \begin{block}{Path 3: "Evolving" PVDF}
                ...
                \begin{itemize}\footnotesize
                    ...
                    \item High polarity advantage
                \end{itemize}
            \end{block}
            
            \vspace{0.1cm}
            \begin{exampleblock}{Strategic Direction}
                \footnotesize \textbf{Industry must pursue parallel strategies:}\\
                Green processing for current tech, alternatives for next-gen batteries
            \end{exampleblock}
        \end{column}
    \end{columns}
\end{frame}
