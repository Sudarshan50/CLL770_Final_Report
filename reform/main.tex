...
{\LARGE\bfseries\color{primaryblue}\textls[80]{DELHI}}\\[0.2em]
  ...
  Modelling Sinusoidal Pressure -- Driven Micro-Scale Flow\\[0.4em]
  in a Water-Based Star Microchannel}\\[2.5cm]
  ...
  {\large Submission Date: 21 November 2025}
...
\noindent This is to certify that the following are the peer evaluations for each team member based on their contributions to the project:
\begin{itemize}
...
\subsection{COMSOL Model Files}

The complete COMSOL Multiphysics model files, including geometry, mesh, and simulation parameters, are available in the project repository:

\vspace{0.5em}
\noindent\textbf{GitHub Repository:} \url{https://github.com/Sudarshan50/CLL770_COMSOL_Report}
